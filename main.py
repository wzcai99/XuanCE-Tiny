...
# from pre-trained 
policy.load_state_dict(torch.load(r"D:\zzm_codes\XuanCE\models\Walker(1)\ppo\model-Wed Mar 29 18_28_02 2023-46000.pth"))
...
agent.benchmark(config.train_steps,config.evaluate_steps, render=True)
